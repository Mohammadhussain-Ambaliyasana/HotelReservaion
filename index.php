...
<h2 class="mt-5 pt-5 mb-4 text-center fn-bold h-font">OUR ROOMS</h2>
    ...
    <?php
      ...
      while($room_data = mysqli_fetch_assoc($room_res)) 
      {
        ...
        if(!$settings_r['shutdown']){
          ...
          $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' class='btn btn-sm text-black custom-bg shadow-none'>Book Now</button>";
        }
...
<h2 class="mt-5 pt-5 mb-4 text-center fn-bold h-font">OUR FACILITIES</h2>
  ...
  <div class="swiper swiper-testimonials">
    <div class="swiper-wrapper mb-5">
      ...
      <div class="swiper-slide bg-white p-4">
        ...
        <h6 class="m-2 ms-2">User 1</h6>
        </div>
        <p>
          Lorem ipsum, dolor sit amet consectetur adipisicing
          elit. Blanditiis quam at recusandae quibusdam beatae
          rerum incidunt odio commodi cumque facilis ad quasi.
        </p>
        <div class="rating">
              <i class="bi bi-star-fill text-warning"></i>
              <i class="bi bi-star-fill text-warning"></i>
...
<div class="container">
  <div class="row">
    <div class="col-lg-8 col-md-8 p-4 mb-lg-0 mb-3 bg-white rounded">
      <iframe class="w-100 rounded nb-4" height="320px" src="<?php echo $contact_r['iframe'] ?>" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    <div class="col-lg-4 col-md-4">
      <div class="bg-white p-4 rounded mb-4">
        ...
        <br>
        <?php
          if($contact_r['pn2']!='' && $contact_r['pn2']!='0'){
            echo<<<data

    ...
    <head>
        <script>
            if (window.history.replaceState) {
                window.history.replacsState(null, null, window.location.href);
            }
        </script>
        <title>HOTEL SUNRISE</title>
        <link rel="icon" href="images/arr.png" height="100%" width="100%">
    ...
    <body>
        ...
        <div class="banner-top">
            ...
            <div class="contact-bnr-w3-agile">
                <ul>
                    ...
                    <li><i class="fa fa-phone" aria-hidden="true"></i>+91 98252 15440</li>
                    <li class="s-bar">
                        <div class="search">
            ...
            <div class="container">
                ...
                <div id="horizontalTab">
                    <ul class="resp-tabs-list">
                        <li>
                            <img src="images/120.jpg" alt=" " class="img-responsive" />
                        </li>
                        <li>
                            <img src="images/teams0.jpg" alt=" " class="img-responsive" />
                        </li>
                        <li>
                            <img src="images/120.jpg" alt=" " class="img-responsive" />
                        </li>
		...
		?>
                ...
                <div class="col-md-3 gallery-grid gallery1">
                    <a href="gallary/<?php echo $res['name']; ?>" class="swipebox"><img src="gallary/<?php echo $res['name']; ?>" class="img-responsive" alt="/">
                        <div class="textbox">
                            <h4>SUN RISE</h4>
                        ...
                        <ul class="slides">
                            <li>
                                <div class="w3layouts_work_grid_left">
                                    ...
                                    <div class="w3layouts_work_grid_left_pos">
                                        <img src="images/300.jpg" alt=" " class="img-responsive" />
                                    </div>
                                </div>
                                <div class="w3layouts_work_grid_right">
                                    <h4>
                                        ...
                                        <i class="fa fa-star" aria-hidden="true"></i>
                                        <i class="fa fa-star" aria-hidden="true"></i>
                                        <i class="fa fa-star" aria-hidden="true"></i> Worth to come again
                                    </h4>
                                    <p>Sed tempus vestibulum lacus blandit faucibus. Nunc imperdiet, diam nec rhoncus ullamcorper, nisl nulla suscipit ligula, at imperdiet urna. </p>
                                    <h5>Warren Buffet</h5>
                                    <p>U.S.A.</p>
                                </div>
                                <div class="clearfix"> </div>
                            ...
                            <li>
                                <div class="w3layouts_work_grid_left">
                                    <img src="images/5.jpg" alt=" " class="img-responsive" />
                                    <div class="w3layouts_work_grid_left_pos">
                                        <img src="images/200.jpg" alt=" " class="img-responsive" />
                                    </div>
                                </div>
                                <div class="w3layouts_work_grid_right">
                                    <h4>
                                        ...
                                        <i class="fa fa-star" aria-hidden="true"></i>
                                        <i class="fa fa-star" aria-hidden="true"></i>
                                        <i class="fa fa-star-o" aria-hidden="true"></i> Worth to come again
                                    </h4>
                                    <p>Sed tempus vestibulum lacus blandit faucibus. Nunc imperdiet, diam nec rhoncus ullamcorper, nisl nulla suscipit ligula, at imperdiet urna. </p>
                                    <h5>Enjlina</h5>
                                    <p>Canada</p>
                            ...
                            <li>
                                <div class="w3layouts_work_grid_left">
                                    <img src="images/5.jpg" alt=" " class="img-responsive" />
                                    <div class="w3layouts_work_grid_left_pos">
                                        <img src="images/400.jpg" alt=" " class="img-responsive" />
                                    </div>
                                </div>
                                <div class="w3layouts_work_grid_right">
                                    <h4>
                            ...
                            <li>
                                <div class="w3layouts_work_grid_left">
                                    <img src="images/5.jpg" alt=" " class="img-responsive" />
                                    <div class="w3layouts_work_grid_left_pos">
                                        <img src="images/Akbar21.jpg" alt=" " class="img-responsive" />
                                    </div>
                                </div>
                                <div class="w3layouts_work_grid_right">
                                    <h4>
        ...
        <section class="contact-w3ls" id="contact">
            <div class="container">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
                    ...
                    <p class="contact-agile1"><strong>Phone :</strong>+91 98252 15440</p>
                    <p class="contact-agile1"><strong>Email :</strong> <a href="mailto:mohammadhussain@.com">INFO@SUNRISE.COM</a></p>
                    <p class="contact-agile1"><strong>Address :</strong> Los Angeles, USA</p>
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3673.247124431647!2d72.49115479999999!3d22.9779384!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e9a96adf0f033%3A0x9a50a496c8175f4a!2sSunrise%20Hotel!5e0!3m2!1sen!2sin!4v1625736942234!5m2!1sen!2sin"></iframe>
                </div>
                <div class="clearfix"></div>
            </div>
        </section>
        <!-- /contact -->
        <div class="copy">
            <p>Copyright &copy; 2022 SUNRISE | All Rights Reserved | Design by <a href="index.php">Mohammadhussain</a> </p>
        </div>
        <!--/footer -->
        <!-- js -->

                    ...
                    echo<<<data
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg-end">
                          <li><a class="dropdown-item" href="bookings.php"><i class="bi bi-bookmark-check"></i> Bookings</a></li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="forgot-form">
        ...
        <div class="modal-body">
          <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
              Note: A Link will be sent to your  registered email to reset password.
          </span>
          <div class="mb-4">
            <label class="form-label">Email</label>

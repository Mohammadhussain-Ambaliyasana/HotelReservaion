<?php
   ...
   define('SENDGRID_API_KEY',"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");
   define('SENDGRID_EMAIL',"abbasalikaradiya07@gmail.com");
   define('SENDGRID_NAME',"Hotel Website");
